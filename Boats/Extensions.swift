...
enum ScrollDirection {
    ...
    func contentOffsetWith(scrollView: UIScrollView) -> CGPoint {
        ...
        case .Bottom:
            let yCord = scrollView.contentSize.height - scrollView.bounds.size.height
            contentOffset = CGPoint(x: 0, y: yCord)//
        case .Left:
...
extension UIScrollView {
    func scrollToBottom(x: CGFloat , keyboardHeight: CGFloat){
        contentOffset = CGPoint(x: x, y: keyboardHeight)//
